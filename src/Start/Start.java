...
public class Start {
    ...
    private static ImageIcon popIcon1;
    private static ImageIcon popIcon2;
    ...
    public Start() {
        ...
        try {
            popIcon1 = new ImageIcon(ImageIO.read(
                    Objects.requireNonNull(Settings.class.getClassLoader().getResourceAsStream("icons/pop_demi.png"))));
            popIcon2 = new ImageIcon(ImageIO.read(
                    Objects.requireNonNull(Settings.class.getClassLoader().getResourceAsStream("icons/pop_comp.png"))));
            pauseIcon = new ImageIcon(ImageIO.read(
                    Objects.requireNonNull(Settings.class.getClassLoader().getResourceAsStream("icons/pause.png"))));
            playIcon = new ImageIcon(ImageIO.read(
                    Objects.requireNonNull(Settings.class.getClassLoader().getResourceAsStream("icons/play.png"))));
            closeBtn.setIcon(new ImageIcon(ImageIO.read(
                    Objects.requireNonNull(Settings.class.getClassLoader().getResourceAsStream("icons/close.png")))));
            restartBtn.setIcon(new ImageIcon(ImageIO.read(
                    Objects.requireNonNull(Settings.class.getClassLoader().getResourceAsStream("icons/restart.png")))));
            settingsBtn.setIcon(new ImageIcon(ImageIO.read(
                    Objects.requireNonNull(Settings.class.getClassLoader().getResourceAsStream("icons/settings.png")))));
