...
public class Settings {
    ...
    private static ImageIcon whiteInfoIcon;
    private static ImageIcon blackInfoIcon;
    private static ImageIcon whiteArrow;
    private static ImageIcon blackArrow;
    private static ImageIcon whiteClose;
    private static ImageIcon blackClose;
    ...
    Settings() {
        ...
        try {
            whiteInfoIcon = new ImageIcon(ImageIO.read(
                    Objects.requireNonNull(Settings.class.getClassLoader().getResourceAsStream("icons/black info.png"))));
            blackInfoIcon = new ImageIcon(ImageIO.read(
                    Objects.requireNonNull(Settings.class.getClassLoader().getResourceAsStream("icons/white info.png"))));
            whiteArrow = new ImageIcon(ImageIO.read(
                    Objects.requireNonNull(Settings.class.getClassLoader().getResourceAsStream("icons/white arrow.png"))));
            blackArrow = new ImageIcon(ImageIO.read(
                    Objects.requireNonNull(Settings.class.getClassLoader().getResourceAsStream("icons/black arrow.png"))));
            whiteClose = new ImageIcon(ImageIO.read(
                    Objects.requireNonNull(Settings.class.getClassLoader().getResourceAsStream("icons/white close.png"))));
            blackClose = new ImageIcon(ImageIO.read(
                    Objects.requireNonNull(Settings.class.getClassLoader().getResourceAsStream("icons/black close.png"))));
